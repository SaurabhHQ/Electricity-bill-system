...
public class Newcustomer extends JFrame implements ActionListener {
    ...
    Newcustomer() {
        ...
        meternumText.setText(String.valueOf(number));
        ...
        next.addActionListener(this);   // ✅ FIX
        panel.add(next);
        ...
        cancel.addActionListener(this); // ✅ FIX
        panel.add(cancel);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == next) {
            ...
            String query_customer =
                    "insert into new_customer values('" + sname + "','" + smeter + "','" +
                            saddress + "','" + scity + "','" + sstate + "','" +
                            eemail + "','" + sphone + "')";

            String query_signup =
                    "insert into Signup values('" + smeter + "','','" + sname + "','','')";
